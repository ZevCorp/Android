...
### Fase 3B — el cableado en `app` (spec aparte, promesas 307-309)

`Ejecucion.kt` construye la puerta (el único sitio), el botón «Parar» del overlay y la acción de la
...
- **El cableado en la app** (`GraphApp.kt`, `MainActivity.kt`, `FloatingBubble.kt`): fase 3B.
