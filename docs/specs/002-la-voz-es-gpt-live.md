...
| 221 | Un ejecutor que lanza: la salida es «la herramienta falló: …» y el turno cierra 2000 ms después. Un resultado de 40 KB viaja en ≤ 32 768 B con la marca de recorte. Una herramienta de control que cancela su propia corrutina: la excepción sale de la tanda y la devolución, en `finally`, cierra igual el turno a los 2000 ms |
