...
class HighlightOverlay(private val service: AccessibilityService) {
     ...
     * resolvería al tocar (ver GraphAccessibilityService.detectClickMismatch). En NARANJA si coincide
     * con lo que tocaste; en ROJO si es un bug (resolvió a un elemento distinto). `null` lo apaga. No
