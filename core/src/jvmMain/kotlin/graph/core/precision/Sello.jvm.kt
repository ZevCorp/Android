...
/** En jvm, HMAC-SHA256 con la llave del proceso. Un `Mac` por llamada: no es seguro entre hilos, y el log sella poco. */
internal actual fun sello(texto: String): String =
