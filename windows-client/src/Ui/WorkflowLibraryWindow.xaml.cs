...
public partial class WorkflowLibraryWindow : Window
{
    ...
    private readonly string _userId, _geminiApiKey, _geminiModel;
    ...
    public WorkflowLibraryWindow(
        GraphConfig graphConfig, BackendClient backend, VideoLibrary videoLibrary,
        string userId, string geminiApiKey, string geminiModel)
    {
        InitializeComponent();
    ...
    private async Task StartTeachingAsync()
    {
        ...
        _teachSession = new WorkflowTeachSession(
            _graphClient, _graphConfig, _uia, _sap, _backend, _videoLibrary, _userId, _geminiApiKey, _geminiModel);
