...
public sealed class WorkflowTeachSession : IAsyncDisposable
{
    ...
    public WorkflowTeachSession(
        ...
        BackendClient backend, VideoLibrary videoLibrary, string userId, string geminiApiKey, string geminiModel)
    {
        _graph = graph;
    ...
    public async Task StartAsync(string description, CancellationToken ct)
    {
        ...
        var teach = new TeachSession(_backend, _videoLibrary, _userId, _geminiApiKey, _geminiModel);
